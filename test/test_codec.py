...
""")
        ...
        result = decode(b'\x04\x00\x00\x10\x00\x00\x00\x00\x00\x01\x00\x08\x00\x00\x00\x10')
        self.assertEqual(result, """---
type:            HELLO
xid:             0x00000000
version:         0x04
...
""")
        ...
        result = decode(b'\x06\x00\x00\x10\x00\x00\x00\x00\x00\x01\x00\x08\x00\x00\x00~')
        self.assertEqual(result, """---
type:            HELLO
xid:             0x00000000
version:         0x06
