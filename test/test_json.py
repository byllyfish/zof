...
def _test_performance(data):
    ...
    result = timeit.timeit(stmt, setup='from zof.objectview import from_json', number=10000)
    print('test_from_json_speed=%r' % result)

    try:
        result = timeit.timeit(stmt, setup='from ujson import loads as from_json', number=10000)
