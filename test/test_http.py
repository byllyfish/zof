...
class HttpTestCase(AsyncTestCase):
    ...
    async def test_http_server(self):
        ...
        async def _post(var1, var2, var3, post_data):
            return {'var1': var1, 'var2': var2, 'var3':var3, 'post_data':post_data}
        ...
        data = await client.post_json('http://127.0.0.1:9010/test/a?var2=3&var3=4', post_data={'x': 1})
        self.assertEqual(data, {'var1': 'a', 'var2':'3', 'var3':'4', 'post_data': {'x': 1}})
